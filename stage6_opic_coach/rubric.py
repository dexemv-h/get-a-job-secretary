...
# 음성이 제공되지 않았을 때 발음/억양 항목에 넣는 고정 문구
...
## 6. 발음
음성이 제공된 경우에만 발음·억양·rhythm을 평가한다.
transcript만 있으면 "{NO_AUDIO_PRONUNCIATION}"라고 명시하고, 텍스트만 보고 추측하지 마라.
원어민 accent와 다르다는 이유만으로 감점하지 마라. Comprehensibility 중심으로 판단한다.
